...
def checkMaterialcompatibility(active_quality_group, global_container_stack):
    ...
    materialcompatibility['PLA'] = ['PLA', 'Fillamentum PLA', 'Matterhackers PLA','Smart Materials PLA', 'Tough PLA','PVA', 'BVOH', 'TPU', 'Ultrafuse TPU 64D', 'AMBX PLA']
    materialcompatibility['Tough PLA'] = ['PLA', 'Fillamentum PLA', 'Matterhackers PLA','Smart Materials PLA', 'Tough PLA','PVA', 'BVOH', 'TPU', 'Ultrafuse TPU 64D', 'AMBX PLA']
    materialcompatibility['PVA'] = ['PLA', 'Fillamentum PLA', 'Matterhackers PLA','Smart Materials PLA', 'Tough PLA','PVA', 'TPU', 'Ultrafuse TPU 64D', 'PAHT CF15', 'PET CF15', 'AMBX PLA']
    materialcompatibility['BVOH'] = ['PLA', 'Fillamentum PLA', 'Matterhackers PLA','Smart Materials PLA', 'Tough PLA', 'BVOH', 'ABS', 'TPU','Ultrafuse TPU 64D', 'PA', 'PAHT CF15', 'PET CF15', 'AMBX PLA']
    materialcompatibility['ABS'] = ['BVOH', 'ABS', 'Smart Materials ABS', 'Ultrafuse PC ABS FR', 'Matterhackers ABS', 'TPU','Ultrafuse TPU 64D','PAHT CF15', 'PET CF15']
    materialcompatibility['Smart Materials ABS'] = ['BVOH', 'ABS', 'Smart Materials ABS', 'Ultrafuse PC ABS FR', 'Matterhackers ABS', 'TPU','Ultrafuse TPU 64D','PAHT CF15', 'PET CF15']
    materialcompatibility['PET-G'] = ['PET-G',  'Fillamentum PET-G','Matterhackers PET-G', 'PET CF15']
    materialcompatibility['TPU'] = ['PLA', 'Fillamentum PLA', 'Matterhackers PLA','Smart Materials PLA', 'Tough PLA', 'BVOH', 'PVA', 'ABS', 'TPU','Ultrafuse TPU 64D', 'PET CF15', 'AMBX PLA']
    materialcompatibility['PA'] = ['BVOH', 'PA']
    materialcompatibility['PP'] = ['PP']
    materialcompatibility['PAHT CF15'] = ['PVA', 'BVOH', 'ABS', 'Smart Materials ABS', 'Ultrafuse PC ABS FR', 'Matterhackers ABS', 'PAHT CF15']
    materialcompatibility['PP GF30'] = ['PP GF30']
    materialcompatibility['PET CF15'] = [ 'PVA', 'BVOH', 'ABS', 'Smart Materials ABS', 'Ultrafuse PC ABS FR', 'Matterhackers ABS', 'PET-G',  'Fillamentum PET-G','Matterhackers PET-G', 'TPU','Ultrafuse TPU 64D','PET CF15']
    materialcompatibility['17-4PH'] = ['17-4PH', 'Ultrafuse Support Layer']
    materialcompatibility['316L'] = ['316L', 'Ultrafuse Support Layer']
    materialcompatibility['Ultrafuse ASA'] = ['Ultrafuse ASA', 'Smart Materials ASA',]
    materialcompatibility['Smart Materials ASA'] = ['Ultrafuse ASA', 'Smart Materials ASA',]
    ...
    materialcompatibility['Matterhackers PLA'] = ['PLA', 'Fillamentum PLA', 'Matterhackers PLA','Smart Materials PLA', 'Tough PLA','PVA', 'BVOH', 'TPU', 'AMBX PLA']
    materialcompatibility['Matterhackers Nylon'] = ['Matterhackers Nylon']
    materialcompatibility['Matterhackers ABS'] = ['BVOH', 'ABS', 'Smart Materials ABS', 'Ultrafuse PC ABS FR', 'Matterhackers ABS', 'TPU','Ultrafuse TPU 64D','PAHT CF15', 'PET CF15' 'Matterhackers ABS']
    materialcompatibility['Fillamentum PLA'] = ['PLA', 'Fillamentum PLA', 'Matterhackers PLA','Smart Materials PLA', 'Tough PLA','PVA', 'BVOH', 'TPU', 'AMBX PLA']
    materialcompatibility['Ultrafuse PC ABS FR'] = ['BVOH', 'ABS', 'Smart Materials ABS', 'Ultrafuse PC ABS FR', 'Matterhackers ABS', 'TPU','PAHT CF15', 'PET CF15']
    materialcompatibility['Ultrafuse TPU 64D'] = ['PLA', 'Ultrafuse TPU 64D', 'Fillamentum PLA', 'Matterhackers PLA', 'Tough PLA', 'BVOH', 'PVA', 'ABS', 'Smart Materials ABS', 'TPU', 'PET CF15', 'Smart Materials PLA']
